...
try {
  ...
  // مصفوفة لحفظ روابط الصفحات
  const pageUrls = ['https://hoodexo.github.io/shirt/index.html'];
  ...
  products.forEach(function(product) {
    ...
    if (product.backImage) {
      thumbnailsHTML += `
        <div class="thumbnail">
          <img src="${product.backImage}" alt="${escapeHtml(product.imageAlt || product.title)} - back">
        </div>`;
    }
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .seo-enhanced-content h3 {
      color: var(--dark);
      margin-bottom: 15px;
      font-size: 18px;
    }
    
    .seo-enhanced-content ul {
      list-style: none;
      margin: 15px 0;
    }
    
    .seo-enhanced-content li {
      padding: 8px 0;
      border-bottom: 1px solid var(--light-gray);
    }
    
    .seo-enhanced-content li:last-child {
      border-bottom: none;
    }
    
    .seo-enhanced-content strong {
      color: var(--primary);
    }
      ...
      <div class="product-container">
        <div class="product-gallery">
          ...
          <div class="main-image">
            <img src="${product.image}" alt="${escapeHtml(product.imageAlt || product.title)}" id="mainImage">
          </div>
  ...
  <section class="tabs-section">
    <div class="container">
      ...
      <div class="tab-content active" id="description">
        <p>${escapeHtml(product.tabDescription || product.description)}</p>
      </div>
      ...
      <div class="tab-content" id="specs">
        <table class="specs-table">
          ...
          <tr>
            <td>Print Type</td>
            <td>High-Quality Direct-to-Garment</td>
          </tr>
        </table>
      </div>
      
      <div class="tab-content" id="shipping">
        <p><strong>Shipping:</strong> We offer free standard shipping on orders over $50. Most orders are processed within 24 hours and delivered within 3-5 business days. Express shipping options are available at checkout.</p>
        <p><strong>Returns:</strong> We want you to be completely satisfied with your purchase. If you're not happy with your order for any reason, you can return it within 30 days of receipt for a full refund or exchange. Items must be unworn, unwashed, and in original condition with tags attached.</p>
      </div>
      
      <div class="tab-content" id="reviews">
        <p>Customer reviews will be displayed here. (24 reviews)</p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-content">
        <div class="footer-column">
          <h3>Hoodexo</h3>
          <p>Your go-to destination for high-quality, funny gamer apparel. Level up your style with our unique designs.</p>
        </div>
        ...
        <div class="footer-column">
          <h3>Contact</h3>
          <ul class="footer-links">
            <li><a href="#">support@gamertees.com</a></li>
            <li><a href="#">+1 (555) 123-4567</a></li>
            <li><a href="#">123 Gaming Street, Pixel City</a></li>
          </ul>
        </div>
      </div>
      
      <div class="footer-bottom">
        <p>&copy; 2025 Hoodexo. All rights reserved. | Fast Shipping to USA</p>
      </div>
    </div>
  </footer>
